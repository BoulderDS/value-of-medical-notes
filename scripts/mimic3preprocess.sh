...
# python -m mimic3preprocess.scripts.merge_features $DATA_DIR/in_hospital_retro/ $OUTPUT_DIR/features_24/
...
# python -m mimic3preprocess.scripts.merge_features  $DATA_DIR/in_hospital_retro/ $OUTPUT_DIR/features_retro/
...
#for n in physician # physician_nursing all_but_discharge all
#do
#(python -m mimic3preprocess.scripts.create_in_hospital_mortality_note /data/joe/physician_notes/mimic-data/preprocessed/ /data/joe/physician_notes/mimic-data/mortality/ $n 24)&
#(python -m mimic3preprocess.scripts.create_in_hospital_mortality_note /data/joe/physician_notes/mimic-data/preprocessed/ /data/joe/physician_notes/mimic-data/mortality/ $n 48)&
#(python -m mimic3preprocess.scripts.create_in_hospital_mortality_note /data/joe/physician_notes/mimic-data/preprocessed/ /data/joe/physician_notes/mimic-data/mortality/ $n -1)&
#done
